document.addEventListener("DOMContentLoaded", () => {
    const gdprQuestions = [
        ...
        },
        {
            ...
            options: ["yes", "no", "not sure"],
            type: "radio",
            category: "Accountability and Compliance"
        },
        {
        ...
        {
            question: "Have you appointed a Data Protection Officer (DPO) if your organization requires one under the GDPR?",
            options: ["yes", "no", "not sure"],
            type: "radio",
            category: "Data Protection Officer (DPO)"
        },
        {
